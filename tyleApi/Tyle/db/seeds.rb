...
u5 = User.create!({name:'Josh', code: 5555})
u6 = User.create!({name:'Nico', code: 6666})
u7 = User.create!({name:'Davide', code: 7777})
u8 = User.create!({name:'Natalie', code: 8888})
u9 = User.create!({name:'Euan', code: 9999})
u10 = User.create!({name:'Marie', code: 1234})
u11 = User.create!({name:'Ashleigh', code: 2345})
u12 = User.create!({name:'Iain', code: 3456})
u13= User.create!({name:'Brian', code: 4567})
u14 = User.create!({name:'Joe', code: 5678})
u15 = User.create!({name:'Meghan', code: 6789})
